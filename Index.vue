          ...
          <div :class="['vx-col w-full leftBar relative trans']">
              <div class="h-full">
                  <div class="relative chartBox">
                      <highcharts ref="chartStock" class="wap-chart trans" :constructor-type="'stockChart'"
                          :options="chartOptionsStock"></highcharts>
                      ...
                      <div class="slider sidebarMobile lg:hidden" style="height: 100%;">
                          <div class="slidercontent">
                              ...
                              <div class="flex flex-col justify-between" ref="refProgress"
                                  style="height: calc(100% - 100px);">
                                  <span class="font-12 zIndex99 text-center" style="color: rgb(252, 95, 95);">{{
                                  CSSELL }}%</span>
                                  <vs-progress :style="`width: ${widthProgress}px; margin-left: 10px;`"
                                      class="bg-red progress" :height="4" :percent="CSBUY" color="success">
                                  </vs-progress>
                                  <span class="font-12 zIndex99 text-center" style="color: rgb(49, 186, 160);">{{
                                  CSBUY }}%</span>
                              </div>
                          </div>
                      </div>
                              ...
                              <div class="gauge-meter">
                                  <div class="gauge-meter-sub gauge-meter--os">
                                                  ...
                                                  <span class="gauge-meter-title-icon">
                                                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                          ...
                                                          <g id="c-question" transform="translate(3.068 -8.774)">
                                                              <g id="Ellipse_1825" data-name="Ellipse 1825"
                                                                  transform="translate(-2.068 9.774)" fill="none"
                                                                  stroke="#fefefe" stroke-linecap="square"
                                                              ...
                                                              <g id="question" transform="translate(3.497 13.43)">
                                                                  <path id="Path_30768" data-name="Path 30768"
                                                                      ...
                                                                      transform="translate(-5.694 -1)" fill="#fefefe">
                                                                  </path>
                                                                  <ellipse id="Ellipse_1827" data-name="Ellipse 1827"
                                                                      cx="1.363" cy="1.284" rx="1.363" ry="1.284"
                                      ...
                                      <div class="gauge-meter-border">
                                          ...
                                          <highcharts ref="chartOs" class="gauge-meter-pane" :options="optionsOs">
                                          </highcharts>
                                      </div>
                                  </div>
                                  <div class="gauge-meter-sub gauge-meter--su">
                                      <div class="v-popover gauge-meter-popover">
                                          <div class="trigger" style="display: inline-block;">
                                              <h3 class="gauge-meter-title">
                                                  Summary
                                                  <span class="gauge-meter-title-icon"><svg
                                      ...
                                      <div class="gauge-meter-border">
                                          ...
                                          <!--  -->
                                          <highcharts class="gauge-meter-pane" :options="optionsSu" ref="chartSu">
                                          </highcharts>
                                          <!--  -->
                                      </div>
                                  </div>
                                      ...
                                      <div class="gauge-meter-border">
                                          ...
                                          <ul class="gauge-meter-status-list">
                                              ...
                                              <li class="gauge-meter-status-item">
                                                  <span
                                                      class="gauge-meter-status-value gauge-meter-status-value--neutral">{{
                                                      NumMovNeutral }}</span> <span
                                                      class="gauge-meter-status-text">Neutral</span>
                                              </li>
                                              <li class="gauge-meter-status-item">
                                                  <span
                                                      class="gauge-meter-status-value gauge-meter-status-value--buy">{{
                                          ...
                                          <highcharts class="gauge-meter-pane" :options="optionsMa" ref="chartMa">
                                          </highcharts>
                                      </div>
                                  </div>
                              </div>
          ...
          <div class="vx-col w-full rightBar c-desktop trans">
              <div class="pc block">
                  <div class="mb-6">
                      ...
                      <div class="vx-row m-0 mt-2">
                          ...
                          <div class="item-col md:w-6/12 w-full text-center mt-2 num1">
                              ...
                              <vs-input @keyup="nhapBetAmount" class="w-full inp d1123 fix-dollar" icon-pack="feather"
                  ...
                  <div class="lg:relative mb-5 mt-10">
                      <div class="h-6"></div>
                      <vs-button @click="BetBuySell('buy')" :disabled="!isBet"
                          class="w-full h-12 font-bold mb-3 btn-buy-sell btn-buy" color="success" type="relief"
                          :class="{'disabled': !isBet}">
                          MUA
                          <feather-icon style="top: 5px;" icon="TrendingUpIcon" svgClasses="w-6 h-5"></feather-icon>
                      </vs-button>
                      <div class="pb-1 col-md-12 col-4 bet-box-time"
                          style="border: 1px solid #fa2843;border-radius: 4px;background-color: #1d233b;">
                          <a class="btn btn-trade-time btnTransparent w-100 flex flex-col justify-center items-center"
                              style="height: 50px; color: #fff">
                              <p class="font-14 mb-0 text-timeDown" style="line-height: normal;"
                                  :class="{'text-danger': !isBet}">{{ textTimeDown }}:</p>
                              <p class="mb-0 font-bold ml-1 timer_counter second text-time"
                                  style="line-height: normal;" :class="{'text-danger': !isBet}">{{ seconDown }}s</p>
                          </a>
                      </div>
                      <div class="h-4"></div>
                      <vs-button @click="BetBuySell('sell')" :disabled="!isBet"
                          class="w-full h-12 font-bold btn-buy-sell btn-sell" color="danger" type="relief"
                          :class="{'disabled': !isBet}">
                          BÁN
              ...
              <div class="mobile hidden">
                  ...
                  <div class="relative">
                      <div class="flex">
                          ...
                          <div class="flex relative" style="width: 55rem;">
                              <vs-input readonly="readonly" @click.stop="showMobileMenu=!showMobileMenu"
                                  class="w-full betInput fix-dollar" icon-pack="feather" icon="icon-dollar-sign"
                                  placeholder="10" v-model="betAmount" icon-no-border />
                              <feather-icon @click="clearBAmount()"
                                  style="right: 5px;top: 7px;position: absolute !important" class="cursor-pointer"
                                  icon="XCircleIcon" svgClasses="w-6 h-6 text-grey"></feather-icon>
                          </div>
                  ...
                  <div class="relative mb-5 mt-3">
                      <div style="display: flex; align-items: center;">
                          <vs-button style="flex-grow: 1" size="large" @click="BetBuySell('sell')" :disabled="!isBet"
                              class="font-bold btn-buy-sell btn-sell" color="danger" type="relief"
                              :class="{'disabled': !isBet}">
                              BÁN
                              <feather-icon style="top: 5px;" icon="TrendingDownIcon" svgClasses="w-6 h-5">
                              </feather-icon>
                          </vs-button>
                          ...
                          <vs-button style="flex-grow: 1" size="large" @click="BetBuySell('buy')" :disabled="!isBet"
                              class="font-bold btn-buy-sell btn-buy" color="success" type="relief"
                              :class="{'disabled': !isBet}">
                              MUA
                              <feather-icon style="top: 5px;" icon="TrendingUpIcon" svgClasses="w-6 h-5">
                              </feather-icon>
                          </vs-button>
                      </div>
                  </div>
                          ...
                          <div id="amountWrapper" class="amountWrapper">
                              ...
                              <div class="groupButtonMobile flex">
                                  <div class="flex w-full mr-2">
                                      <vs-button @click="truBetAmount" class="w-full" type="border"
                                          icon-pack="feather" icon="icon-minus"></vs-button>
                                  </div>
                                  <div class="flex relative" style="width: 55rem;">
                                      <vs-input readonly="readonly" @keyup="nhapBetAmount"
                                          class="w-full betInput fix-dollar" icon-pack="feather"
                                          icon="icon-dollar-sign" placeholder="10" v-model="betAmount"
                                          icon-no-border />
                                      <feather-icon @click="clearBAmount()"
                                          style="right: 5px;top: 7px;position: absolute !important;"
                                          class="cursor-pointer" icon="XCircleIcon" svgClasses="w-6 h-6 text-grey">
                                      </feather-icon>
                                  </div>
                                  <div class="flex w-full ml-2">
                                      <vs-button @click="congBetAmount" class="w-full" type="border"
                  ...
                  <div class="wrapNotify congratulation h-100 ">
                      <div class="boxNotify">
                          ...
                          <div class="boxContent flex justify-center items-center flex-col">
                              ...
                              <p class="titleWin">Xin chúc mừng!</p> <span
                                  class="message_money text-4xl font-bold">+{{ moneyWin }}$</span>
                          </div>
