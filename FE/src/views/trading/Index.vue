...
<template>
  <div id="tradePage" class="trade-container" :class="isMobile ? classLandscape : ''">
    <div class="vx-row m-0">
      ...
      <div class="vx-col w-full rightBar c-desktop trans">
        ...
        <div class="mobile hidden">
          <div class="sidebarPC relative" v-if="classLandscape !== 'landscape-primary'">
            <vs-progress
              class="bg-red"
              :height="4"
              :percent="[CSBUY ? CSBUY : 50]"
          ...
          <div class="lg:relative mt-4 text-center color_white" v-if="classLandscape === 'landscape-primary'">
            <div class="text-center">Chỉ báo tâm lý</div>
            <vs-progress
              class="bg-red"
              :height="4"
          ...
          <div class="relative mb-5 mt-3">
            <div style="display: flex; align-items: center" class="box-sell-buy-mobile">
              <vs-button
                style="flex-grow: 1"
                size="large"
                @click="BetBuySell('sell')"
          ...
          <div class="keyboard-input-wrap" :class="{ active: showMobileMenu }">
            ...
            ></div>
            <div class="keyboard" :class="{ hiddenKey: !showMobileMenu, keyboardLandscape : classLandscape === 'landscape-primary' }">
