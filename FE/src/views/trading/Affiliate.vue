                                                ...
                                                <div class="MGT w-full">
                                                    ...
                                                    <div class="groupButton flex mb-4 relative">
                                                        <div class="copy-btn">
                                                            ...
                                                            <div><button class="cursor-pointer copy-btn-button" v-clipboard:copy="linkDk" @click="saoChep">Sao chép</button></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="MGT w-1/2">
                                                    ...
                                                    <div class="groupButton flex mb-4 relative">
                                                        <div class="copy-btn-2">
                                                            ...
                                                            <button class="cursor-pointer copy-btn-button-2 aomalam" v-clipboard:copy="codeGioiThieu" @click="saoChep">Sao chép</button>
                                                        </div>
                                                    </div>   
                                                </div>
                                            </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="textContent">
                                                ...
                                                <p class="color-white-50 mb-0 des">Mời bạn bè đăng ký Dbino qua liên kết</p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="cardBody">
                                                    <div class="vx-row">
                                                        <div class="vx-col lg:w-4/12 text-center">
                                                            ...
                                                            <p class="elipText white text-base mb-2 getIntouch-sub-title">Dbino</p>
                                                        </div>
                                                        <div class="vx-col lg:w-8/12">
                                                            ...
                                                            <p class="flex items-center">
                                                                ...
                                                                <a :href="`mailto:louis00238@gmail.com`" class="elipText white text-base ml-2 getIntouch-value">contact@Dibino.trade</a>
