            ...
            <div class="contentAuthentication bgPrimary flex flex-col items-center justify-between" :class="{'ld-loading': ldFrom}">
                ...
                <div class="header-sidebar p-6 fixed flex items-center justify-between flex-col w-full">
                    ...
                    <div class="formWapper w-full">
                        <div class="loginForm white mt-0" v-if="!isG2FA">
                            ...
                            <div class="centerx labelx">
                                <div class="mb-3">
                                    <vs-input type="email" class="w-full log-email" label="Địa chỉ Email *" placeholder="Điền Email" v-model="email"/>
                                </div>
                        ...
                        <div class="loginForm white mt-0" v-else>
                            ...
                            <div class="centerx labelx">
                                ...
                                <div>
                                    <vs-button color="#34d1d6" class="w-full" type="filled" :disabled="!disabledLogin" @click="loginFormAuthG2FA">Gửi</vs-button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div slot="footer">
                        ...
                        <div class="footer">
                            <span class="colorWhite bottomText text-center">Không nhận được email xác nhận?</span> 
                    ...
                    <div class="formWapper w-full">
                        <div class="regFrom white mt-0" v-if="!isSubmitReg">
                            ...
                            <div class="centerx labelx">
                                ...
                                <div>
                                    <vs-button color="#34D1D6" class="w-full" type="filled" @click="submitFormReg">Đăng ký</vs-button>
                                </div>
                    ...
                    <div class="formWapper w-full">
                        <div class="ResendForm white mt-0" :class="{'block': hideTbResend, 'hidden': !hideTbResend}">
                            ...
                            <div class="centerx labelx">
                                ...
                                <div>
                                    <vs-button color="#34D1D6" class="w-full" type="filled" @click="submitFormResendActive">Gửi lại</vs-button>
                                </div>
                    ...
                    <div class="formWapper w-full">
                        <div class="fotgotForm white mt-0" :class="{'block': hideTbForgot, 'hidden': !hideTbForgot}">
                            ...
                            <div class="centerx labelx">
                                ...
                                <div>
                                    <vs-button color="#34D1D6" class="w-full" type="filled" @click="submitFormForgot">Gửi</vs-button>
                                </div>
                            </div>
                        </div>
...
.logoLogin {
    background-image: url('~@/assets/images/sky/logo.57b09ac4.svg');
    display: block;
    height: 40px;
    width: 170px;
