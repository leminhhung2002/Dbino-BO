  ...
  <div class="footerFAQs">
    <div class="container position-relative">
      ...
      <div class="ft-1">
        <div class="block">
          <p class="des1">
            Dbino is authorised by the Dbino TRADING LIMITED and regulated
            under the Judicial Authority of Portugal. Dbino TRADING LIMITED
          ...
          <p style="text-align: center" class="des2">
            © Dbino {{new Date().getFullYear()}} All rights reserved. ’Dbino’ is a trademark of the
            Dbino TRADING LIMITED.
          </p>
        </div>
      </div>
    </div>
