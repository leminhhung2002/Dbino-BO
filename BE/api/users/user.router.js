const {
  ...
  getListNotifi,
  updateListNotifi,
  createAdminGoogle2FA,
  activeAdminGoogle2FA,
  unActiveAdminGoogle2FA,
...
app.post("/update-admin-gg2fa", activeAdminGoogle2FA);

app.post("/disable-gg2fa", checkToken, unActiveGoogle2FA);

app.post("/disable-admin-gg2fa", unActiveAdminGoogle2FA);

app.get("/create-gg2fa", checkToken, createGoogle2FA);

app.get("/create-admin-gg2fa", createAdminGoogle2FA);
