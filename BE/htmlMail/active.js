          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
            ...
            <tr>
              <td align="center" style="padding-top:10px;padding-bottom:10px">
                <a href="${linkActive}" style="text-align:center;padding:0 20px;line-height:50px;overflow:hidden;border-radius:5px;text-decoration:none;background-color:#34d1d6;color:#fffffe;font-size:16px;margin-bottom:10px;display:inline-block;font-weight:bold" target="_blank">Activate Now</a>
              </td>
            </tr>
            <tr>
              <td style="padding-top:5px;padding-bottom:5px">
