      ...
      <td>
	    <div style="background-color:#34d1d6;padding-left:30px;padding-right:30px;padding-top:10px;padding-bottom:10px;color:#fffffe;border-radius:10px 10px;margin-bottom:10px">
		  <div style="font-size:20px;font-weight:bold">
		    You Have Signed In From A New Ip Address
		  </div>
		  </div>
      </td>
    </tr>
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
            ...
            <tr>
              <td style="padding-top:5px;padding-bottom:5px">
                 Your account have been successfully signed in from a new IP address. Please verify the follow
                information and if this wasn't you, please take immediate actions to protect your account.
              </td>
            </tr>
            <tr>
                <td style="padding-top:5px;padding-bottom:5px">
                    <span style="font-weight:bold">IP Address:</span> ${Ip}
                </td>
            </tr>
            <tr>
                <td style="padding-top:5px;padding-bottom:5px">
                    <span style="font-weight:bold">Operating System:</span> ${OSysTeam}
                </td>
            </tr>
            <tr>
                <td style="padding-top:5px;padding-bottom:5px">
                    <span style="font-weight:bold">Browser:</span> ${Brow}
                </td>
            </tr>
            <tr>
              <td style="padding-top:5px;padding-bottom:5px">
