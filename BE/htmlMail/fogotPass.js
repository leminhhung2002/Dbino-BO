      ...
      <td>
	    <div style="padding-top:20px;padding-bottom:25px;padding-left:30px;padding-right:30px;border-radius:10px 10px;border-top:none;background:#06173f url(https://didi.azureedge.net/chart-email.png) no-repeat center bottom">
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
            ...
            <tr>
              <td style="padding-top:5px;padding-bottom:5px">
                You have requested to reset your password. Click below button to change it.
              </td>
            </tr>
            <tr>
              <td align="center" style="padding-top:10px;padding-bottom:10px">
                <a href="${token}" style="text-align:center;padding:0 20px;line-height:50px;overflow:hidden;border-radius:5px;text-decoration:none;background-color:#34d1d6;color:#fffffe;font-size:16px;margin-bottom:10px;display:inline-block;font-weight:bold" target="_blank">Change password</a>
              </td>
            </tr>
            <tr>
              <td style="padding-top:5px;padding-bottom:5px">
